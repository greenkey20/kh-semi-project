...
public class EmailCheckController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String user = "dlfwh1234@naver.com"; // 자신의 네이버 계정
		String password = "thswkqwh1234";// 자신의 네이버 패스워드
		...
		try {
			...
			msg.setFrom(new InternetAddress(user, "놀멍쉬멍"));
			msg.addRecipient(Message.RecipientType.TO, new InternetAddress(to_email));

			// 메일 제목
			msg.setSubject("안녕하세요 놀멍쉬멍 이메일 인증 코드입니다.");
			// 메일 내용
