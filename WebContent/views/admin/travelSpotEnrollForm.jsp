<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% 
	String category = (String)request.getAttribute("category"); // HOTEL 또는 LANDSCAPE 또는 ACTIVITY
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>여행지 추가/등록</title>
<style>
	.outer {
...
<body>
    ...
    <div class="outer">
        ...
        <form id="enroll-form" action="<%= contextPath %>/insertTravelSpot.ads" method="post" enctype="multipart/form-data">
        	<!--2022.1.31(월) 11h10 서블릿 만들며 추가-->
        	<input type="hidden" name="category" value="<%= category %>"> <!--HOTEL 또는 LANDSCAPE 또는 ACTIVITY-->
        	
            <!--2022.1.31(월) 10h40 테이블 형태로 만듦-->
            <table align="center" border="1">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select name="area" id="area">
                            <option value="제주" selected>제주시</option>
                ...
                <% if (category.equals("ACTIVITY")) { %>
					<tr>
	                    <th>준비물</th>
	                    <td colspan="3"><input type="text" name="equipment"></td>
	                </tr>
				<% } %>
